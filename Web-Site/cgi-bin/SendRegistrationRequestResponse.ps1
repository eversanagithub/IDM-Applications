<#
		Program Name: SendRegistrationRequestResponse.ps1
...
$Associate_EMail_File = "C:/Apache24/cgi-bin/HTMLRegistrationRequestResponse.txt"
$HTMLFailedFile = "C:/Apache24/cgi-bin/HTMLInviteFailedFile.txt"
...
try
{
	...
	$addAccessSubjectLine = "Thank you for your interest in registering for the IDM website " + $FirstName + " " + $LastName
	$body = Get-Content $Associate_EMail_File -Raw
