...
#################################################################################################
#                                                                                               #
#       Program Name: CreateModifyUserAttributesPage.pl                                         #
...
my $ModifierUserMenu = "C:\\Apache24\\htdocs\\php\\HousekeepingScripts\\DisplayModifyUserAttributesPage.php";

my $phpOutput = `$PHP $ModifierUserMenu`;
print "$phpOutput";
