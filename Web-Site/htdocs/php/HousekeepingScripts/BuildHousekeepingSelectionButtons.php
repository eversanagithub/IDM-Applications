...
/*
----------------------------------------------------------------------------------------------------------------
|     Script Name: BuildHousekeepingSelectionButtons.php                                                       |
...
|         Purpose: Retrieves the Housekeeping Button attributes so the button objects can be made.             |
|--------------------------------------------------------------------------------------------------------------- */
...
// Get record count
$CountNumRecords = "select count(*) from WebBuildHousekeepingButtons;";
$rs = odbc_exec($conn,$CountNumRecords);
odbc_fetch_row($rs);
$NumRecords = odbc_result($rs,$Count);

$sql="select * from WebBuildHousekeepingButtons;";
