...
/*
        Program Name: DisplayAddUserToPortalHTMLResponse.php
        Date Written: May 8th, 2023
          Written By: Dave Jaynes
  Function Called By: CreateADACHTMLResponse() function
             Purpose: This php script is called by the 'CreateAddUserToPortalHTMLResponse.pl' perl script
					  when displaying the contents of the 'AddUserToPortalMenuOutput.txt' file to the screen.
*/
