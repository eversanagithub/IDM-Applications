...
// Get record count
$CountNumRecords = "select count(*) from Feed_AD_Azure where (extensionAttribute4 like 'FTE%' or extensionAttribute4 like '%human%') and UPN not like 'srv_%' and AccountEnabled = 'True';";
