...
$TestingFile = "C:/apache24/htdocs/php/BuildWebpageScripts/ADACTestingFile.txt";
...
function BuildSuccessPage($ADACOutput)
{
	...
	$txt = "</head>";
	fwrite($fh,$txt);
	$txt = "<body onLoad='DisplayADACIntro()' bgcolor='#0F0141'>\n";
	fwrite($fh,$txt);
	...
	$txt = "<th width='%22' align='center'>\n";
	fwrite($fh,$txt);
	$txt = "<p class='WhiteText_P15'>Job Description</p>\n";
	fwrite($fh,$txt);
	$txt = "</th>\n";
	fwrite($fh,$txt);
	$txt = "<th width='22%' align='center'>\n";
	...
	$txt = "<td width='22%' align='center'>\n";
	fwrite($fh,$txt);
	$txt = "<input id='jobDescription' name='jobDescription' type='text' placeholder='e.g. SyS Admin'>\n";
	fwrite($fh,$txt);
	$txt = "</td>\n";
	fwrite($fh,$txt);
	$txt = "<td width='22%' align='center'>\n";
...
function BuildIllegalPage($ODDOutput,$webUserDTG,$lastName,$firstName,$userID,$IDActive,$loginDTG,$TimeCheckPassed,$illegalAccess)
{
...
function BuildFailedPage($ODDOutput,$webUserDTG,$lastName,$firstName,$userID,$IDActive,$loginDTG,$TimeCheckPassed,$illegalAccess)
{
	$fh = fopen($ODDOutput, "a");
	$txt = "Content-type: text/html\n\n";
	fwrite($fh,$txt);
