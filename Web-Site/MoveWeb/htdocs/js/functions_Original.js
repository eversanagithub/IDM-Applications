...
const PHPFileName = "http://iuatidmgmtapp01/Applications/php/GetNewRegisteredUserInfo.php";
const getMainApplicationURLValues = "http://iuatidmgmtapp01/Applications/php/BuildWebPageScripts/GetMainApplicationURLValues.php";
const GetAPApplicationLevelPHP = "http://iuatidmgmtapp01/Applications/php/GetAdminPortalApplicationValues.php";
const GetAPApplicationURLValue = "http://iuatidmgmtapp01/Applications/php/GetAdminPortalApplicationURL.php";
const getUserAttributes = "http://iuatidmgmtapp01/Applications/php/ReturnUserAttributes.php";
const GetUserAccessLevelValue = "http://iuatidmgmtapp01/Applications/php/GetUserAccessLevelValue.php";
const WhoAmIURL = "http://iuatidmgmtapp01/Applications/php/WhoAmI.php";
const GetHKApplicationURLValues = "http://iuatidmgmtapp01/Applications/php/BuildWebPageScripts/GetHousekeepingURLValues.php";
const ExecuteTerminationURL = "http://iuatidmgmtapp01/Applications/php/ExecuteTermination.php";
const FormerAssociateDropDownListURL = "http://iuatidmgmtapp01/Applications/OneDriveDelegation/php/InitialFormerAssociateDropDownList.php";
const BuildMainSelectionButtonsURL = "http://iuatidmgmtapp01/Applications/php/BuildMainSelectionButtons.php";
const BuildAdminPortalSelectionButtonsURL = "http://iuatidmgmtapp01/Applications/php/BuildAdminPortalSelectionButtons.php";
const BuildHousekeepingSelectionButtonsURL =  "http://iuatidmgmtapp01/Applications/php/HousekeepingTasks/BuildHousekeepingSelectionButtons.php";
const CreateRegisterUserDropDownPHPFile = "http://iuatidmgmtapp01/Applications/php/CreateRegisterUserDropDown.php";
const LoadTextTrackingTablePHPFile = "http://iuatidmgmtapp01/Applications/php/LoadTextTrackingTable.php";
const DisplayTerminatedAccountsPHPFile = "http://iuatidmgmtapp01/Applications/php/DisplayTerminatedAccounts.php";
const StoreEmployeeIDSearchStringPHPFile = "http://iuatidmgmtapp01/Applications/AssociateTerminations/php/StoreEmployeeIDSearchString.php";
const InitialFormerAssociateDropDownListPHPFile = "http://iuatidmgmtapp01/Applications/OneDriveDelegation/php/InitialFormerAssociateDropDownList.php";
const InitialRequesterDownListPHPFile = "http://iuatidmgmtapp01/Applications/OneDriveDelegation/php/InitialRequesterDownList.php";
const UpdateFormerAssociateDropDownListPHPFile = "http://iuatidmgmtapp01/Applications/OneDriveDelegation/php/UpdateFormerAssociateDropDownList.php";
const UpdateRequesterDropDownListPHPFile = "http://iuatidmgmtapp01/Applications/OneDriveDelegation/php/UpdateRequesterDropDownList.php";
const StatusOfODDProgressPHPFile = "http://iuatidmgmtapp01/Applications/php/StatusOfODDProgress.php";
const LocationNameDropDownListPHPFile = "http://iuatidmgmtapp01/Applications/php/LocationNameDropDownList.php";
...
const ResetTimer = (EmpID) => {
	...
	xhr.open("POST", "http://iuatidmgmtapp01/Applications/php/ResetTimer.php", true);
...
const DisplayODDIntro = () => {
	...
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/OneDriveDelegation/webpages/onedrivedelegation.htm';
}

const DisplayADACIntro = () => {
	// Called by the SearchBoxes.html file.
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/ADAccountCreation/webpages/CreateADACHTMLResponse.htm';
}

const DisplayTermIntro = () => {
	// Called by the SearchBoxes.html file.
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/webpages/AssociateTermination.htm';
}
...
const SubmitDetailedListing = () => {
	...
	var xhr = new XMLHttpRequest();
	xhr.open("POST", "http://iuatidmgmtapp01/Applications/php/SetWebUserDTG.php", true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	xhr.send(params);
...
const SubmitODDRequest = () => {
	// top.mainpanel.location='http://iuatidmgmtapp01/Applications/OneDriveDelegation/webpages/StatusOfODDProgress.html';
	document.getElementById('Submit').disabled = true;
...
const ShowTimeOutScreen = () => {
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/webpages/TimeOut.htm';
}

const ShowIllegalAccessScreen = () => {
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/webpages/IllegalAccess.htm';
}
...
const DisplayNewUserAddMessage = () => {
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/webpages/DisplayNewUserAddMessage.htm';
	let form = document.getElementById("AddUserToPortal");
	form.submit();
}

const DisplayIDMBanner = () => {
	top.topmainpanel.location='http://iuatidmgmtapp01/Applications/webpages/AdminPortalWelcomeBanner.htm';
}
...
const InsertNewTimeStamp = (webUserDTG,myDTG,userID,lastName,firstName,IDActive,loginAttempt) => {
	...
	var xhr = new XMLHttpRequest();
	xhr.open("POST", "http://iuatidmgmtapp01/Applications/php/LogInitialVisit.php", true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	xhr.send(params);
}
...
const SendMainPageParameters = (user,EncryptedKey,applicationURL) => {	
	...
	console.log('Troubleshoot line 261: user = [' + user + '], EncryptedKey = [' + EncryptedKey + ']');
	sendGoodRequest = new XMLHttpRequest();
...
const GetHKApplicationURL = (application,GetHKApplicationURLValues,returnApplicationURL) => {		
	let applicationURL = "";
	console.log('Passed application is [' + application + ']');
	let getInfoParams = 'application=' + application;
	const requestApplicationURL = new XMLHttpRequest();
	requestApplicationURL.addEventListener('readystatechange', () => {
		if(requestApplicationURL.readyState === 4 && requestApplicationURL.status === 200) 
...
const CreateHKHTMLResponse = (application) => {
	GetHKApplicationURL(application,GetHKApplicationURLValues,function(applicationURL)
	{
		...
		console.log('Returned applicationURL = [' + applicationURL + ']');
...
const CreateRegisterHTML = (Name,EmplID,CookieStatus) => {		
	...
	var xhr = new XMLHttpRequest();
	xhr.open("POST", "http://iuatidmgmtapp01/Applications/php/CreateRegisterHTML.php", true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	xhr.send(params);
}
...
const RegisterNewUser = () => {
	...
	const RetrieveInitialEncryptedKey = "http://iuatidmgmtapp01/Applications/php/HousekeepingTasks/RetrieveInitialEncryptedKey.php"
	...
	top.mainpanel.location='http://iuatidmgmtapp01/Applications/webpages/Register.htm';
...
function DisplayTerminatedAccounts(assocID)
{
	...
	top.topmainpanel.location='http://iuatidmgmtapp01/Applications/webpages/TermTitlePage.html';
}
...
const initialTopDisplay = () => {
	...
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/webpages/InitialTopDisplay.htm';
	}
}
...
const BlueBlank_Description = () => {
	...
	if(DisplayRollovers == 'Yes')
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/webpages/blueblank.htm';
	}
}
...
const Admin_Portal_Description = () => {
	...
	if(DisplayRollovers == 'Yes')
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/webpages/admin_portal_rollover_desc.htm';
	}	
}
...
const ADAC_Description = () => {
	...
	if(DisplayRollovers == 'Yes')
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/ADAccountCreation/webpages/ADAC_Description.htm';
	}
}
...
const ODD_Description = () => {
	...
	if(DisplayRollovers == 'Yes')
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/OneDriveDelegation/webpages/ODD_Description.htm';
	}
}
...
const EmployeeTerminationDescription = () => {
	...
	if(DisplayRollovers == 'Yes')
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/AssociateTerminations/webpages/EmployeeTerminationDescription.htm';
	}
}
...
const PortalLogoutBanner = () => {
	...
	if(DisplayRollovers == 'Yes')
	{
		top.topmainpanel.location='http://iuatidmgmtapp01/Applications/webpages/PortalLogoutBanner.htm';
	}
}
