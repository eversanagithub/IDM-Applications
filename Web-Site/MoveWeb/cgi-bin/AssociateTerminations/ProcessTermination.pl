...
sub ProcessTermination
{
	...
	my $TermTitlePage = "c:/Apache24/htdocs/Applications/webpages/TermTitlePage.html";
	...
	print "<BODY onLoad=";
	print '"';
	print "ExecuteTermination($POST_AssocID);DisplayTerminatedAccounts($POST_AssocID);ResetTimer($WhoAmI)";
	print '" ';
