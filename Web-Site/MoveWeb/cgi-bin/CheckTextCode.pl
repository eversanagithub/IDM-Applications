...
sub DisplaySuccess
{
	...
	print "<HTML>\n";
	print "<HEAD>\n";
	print "	<script LANGUAGE=JAVASCRIPT src=http://iuatidmgmtapp01/Applications/js/FormSubmitting_functions.js></script>\n";
	print "	<script LANGUAGE=JAVASCRIPT src=http://iuatidmgmtapp01/Applications/js/RollOver_functions.js></script>\n";
	print "	<script LANGUAGE=JAVASCRIPT src=http://iuatidmgmtapp01/Applications/js/AJAX_functions.js></script>\n";
	print "  <link rel='stylesheet' href='http://iuatidmgmtapp01/Applications/css/styles.css'>\n";
	print "</head>\n";
	print "<BODY style=";
	print '"';
	print "background-image: url('http://iuatidmgmtapp01/Applications/images/bluebackground.jpg');";
	print '"';
	print ">\n";
	...
	print "<img width=600 height=600 src='http://iuatidmgmtapp01/Applications/images/ThumbsUpLogin.jpg'>\n";
	print "		</td>\n";
	print "	</tr>\n";
	print "</table>\n";
	print "<br><br>\n";
	...
	print "<input id='Submit' name='Submit' type='image' src='http://iuatidmgmtapp01/Applications/images/buttons/ProceedToAdminPortal.jpg' width=200 height=47 align='middle' border='0' onClick='SetShowDescriptionsOff();LaunchAdminPortalBuildPage();'>\n";
	print "</p>\n";
	print "</td>\n";
	print "</tr>\n";
	print "</table>\n";
...
sub DisplayFailure
{
	...
	print "	<tr>\n";
	print "		<td align='center'>\n";
	print "<img width=600 height=600 src='http://iuatidmgmtapp01/Applications/images/LoginFailed.jpg'>\n";
	print "		</td>\n";
	print "	</tr>\n";
	print "</table>\n";
	print "<br><br>\n";
	...
	print "<td align='center'>\n";
	print "<p>\n";
	print "<a href='http://iuatidmgmtapp01/Applications/index.html' target='_parent'>\n";
	print "<img width=200 height=47 src='http://iuatidmgmtapp01/Applications/images/buttons/ReturnToMainScreen.jpg' onClick='SetShowDescriptionsOff();'>\n";
	print "</a>\n";
	print "</p>\n";
	print "</td>\n";
	print "</tr>\n";
