...
#            Purpose: This script creates the InitiateTables Perl script by walting through     #
#                     each table and quering the table fields and rows within the table.        #
#                     It then reproduces and delete table and create table syntax as well as    #
#                     creating the insert tables for current data within the tables.            #
#                                                                                               #
#################################################################################################
...
$InitiateTablesFile = "C:/Apache24/cgi-bin/InitiateTables.pl";
...
print InitiateTablesFile "#            Purpose: This script creates the InitiateTables Perl script by walting through     #\n";
print InitiateTablesFile "#                     each table and quering the table fields and rows within the table.        #\n";
print InitiateTablesFile "#                     It then reproduces and delete table and create table syntax as well as    #\n";
print InitiateTablesFile "#                     creating the insert tables for current data within the tables.            #\n";
print InitiateTablesFile "#                                                                                               #\n";
print InitiateTablesFile "#################################################################################################\n\n";
...
while (@row = $sth->fetchrow_array())
{
	$Table = $row[0];
	chomp($Table);
	if($Table ne "WebDelegatesAlreadyProcessed") 
	{
