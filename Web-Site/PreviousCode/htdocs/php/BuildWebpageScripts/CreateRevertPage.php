...
$PromoteWebsiteOutput = "C:/apache24/htdocs/php/WebsiteTextOutputFiles/RevertScriptOutput.txt";
...
function BuildSuccessPage($PromoteWebsiteOutput)
{
	...
	$txt = "<td width='100%'>\n";
	fwrite($fh,$txt);
	$txt = "<p class='MainHeader'>Click the Revert Code button to initiate the process of reverting to the previous code release</p>\n";
	fwrite($fh,$txt);	
	$txt = "</td>\n";
	fwrite($fh,$txt);
	$txt = "</tr>\n";
	...
	fwrite($fh,$txt);
	$txt = "<button class='styledButton' id='Submit' name='Submit' type='submit' value='Submit'>Revert Code</button>\n";
	fwrite($fh,$txt);
	$txt = "</td>\n";
	fwrite($fh,$txt);
	$txt = "</tr>\n";
	...
	$txt = "<td width='100%' align='center'>\n";
	fwrite($fh,$txt);
	$txt = "<img width=400 height=400 src='http://idmgmtapp01/images/RevertCode.jpg'>\n";
	fwrite($fh,$txt);
	$txt = "</td>\n";
	fwrite($fh,$txt);
	$txt = "</tr>\n";
