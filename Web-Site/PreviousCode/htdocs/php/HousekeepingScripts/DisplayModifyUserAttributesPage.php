...
/*
        Program Name: DisplayModifyUserAttributesPage.php
...
$myfile = fopen($CreateModifyUserAttributesOutput, "r") or die("Unable to open file!");
echo fread($myfile,filesize($CreateModifyUserAttributesOutput));
fclose($myfile);
?>
