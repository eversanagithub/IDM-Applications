...
$azureUser = "Srv_Orchestration@eversana.com"
$azurePass = Get-Content "C:\PowerShell\ServiceNow-Orchestration-OnPrem\Srv_Orchestration.txt" | ConvertTo-SecureString
